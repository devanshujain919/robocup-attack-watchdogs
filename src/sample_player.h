...
public:
    ...
    void
    writeState( rcsc::PlayerAgent *agent, std::string prevState, int action, int action_arg, double q_value );

    std::string 
    chooseAction(rcsc::PlayerAgent *agent, double *q_value, std::string ss);
